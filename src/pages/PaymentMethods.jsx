    ...
    <ContentMain>
      <ContentInfoPayments className="container section">
        ...
        <p>
          ...
          realizar el pago de tu anticipo en un plazo máximo de 3 días, si no se
          cancelara el evento y la fecha que apartaste. Normalmente las
          transferencias se reflejan en nuestra cuenta en un plazo de 24-48
          horas. La preparación y realización de su evento/fiesta no se realiza
          hasta que recibamos el pago de anticipo en nuestras cuenta o nos
          envíes el comprobante por <b>whatsapp</b>.
        </p>

        <h3 className="red-color">Efectivo</h3>
        <p>
          Podemos acordar un lugar o bien, visitar la empresa hecho con amor en:{" "}
          <b>Morelos Pte., 61992 Vicente Riva Palacio, Mich.</b> para realizar
          tu pago en efectivo.
        </p>
...
`;
const ContentInfoPayments = styled.article`
  h3 {
